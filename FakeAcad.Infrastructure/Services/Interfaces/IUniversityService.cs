...
public interface IUniversityService
{
    ...
    public Task<ServiceResponse<ICollection<UniversityDTO>>> GetUniversitiesByProfessor(string firstName, string lastName, CancellationToken cancellationToken = default);

    public Task<ServiceResponse<ICollection<UniversityDTO>>> GetUniversitiesByArticle(string article, CancellationToken cancellationToken = default);
